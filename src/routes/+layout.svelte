...
<nav class="navbar fixed inset-0 z-50 h-20 w-full bg-gray-50">
	...
	<!-- Top bar -->
	<section class="flex items-center justify-between bg-blue-950 px-12 py-1.5 text-gray-50">
		<!-- Logo -->
		<div class="flex items-center gap-3">
			<a class="flex h-5 w-5 items-center justify-center" href="https://instagram.com/">
				<svg
		...
		<div class="flex items-center">
			<a href="/myUnram" class="px-2 text-xs font-semibold tracking-tight">myUnram</a>
			<a href="/myUnram" class="px-2 text-xs font-semibold tracking-tight">TOEFL</a>
			<a href="/myUnram" class="px-2 text-xs font-semibold tracking-tight">Result</a>
			<a href="/myUnram" class="px-2 text-xs font-semibold tracking-tight">Contact</a>
		</div>
	</section>
	<!-- Main bar -->
	<section class="flex items-center justify-between border-b border-gray-100 bg-gray-50 px-10 py-3">
		<!-- Logo -->
		<a href="/" class="flex basis-1/3 items-center justify-start gap-2">
			<img class="h-12 w-12" src="/assets/general/unram-logo.png" alt="Unram Logo" />
		...
		<div class="flex basis-1/3 items-center justify-center gap-1.5">
			<a href="/profile" class="p-2 text-sm font-medium hover:underline">Profil</a>
			<button class="flex items-center gap-1 p-2 text-sm font-medium hover:underline">
				Program
			...
			<a href="/partnership" class="p-2 text-sm font-medium hover:underline">Partnership</a>
			<a href="/galeri" class="p-2 text-sm font-medium hover:underline">Galeri</a>
		</div>
