	...
	>
		<Carousel.Content class="w-full">
			{#each data as slider}
				...
				>
					<div
						class="absolute z-10 h-full w-full bg-gradient-to-t from-stone-950/95 via-stone-800/30 to-stone-950/5"
					/>
					...
					<img
						class="relative z-0 h-full w-full scale-100 object-cover object-bottom"
